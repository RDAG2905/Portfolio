CREATE PROCEDURE [GetDenunciasPorResponsableFechasNGciayOrganismo]
    @responsableId [int],
    @organismoId [int],
    @fechaDesdeNGcia [datetime],
    @fechaHastaNGcia [datetime]
AS
BEGIN
     	
    Select td.DenunciaId,td.EXPEDIENTE_ID,td.FCREACION,tor.Nombre as Organismo,ts.Nombre as Servicio,
    testu.Nombre as Estudio,tden.apellido as Apellido,tden.nombre as Nombre,
    	            test.Nombre as EtapaProcesal,tsub.Nombre as EstadoActual ,ttp.Nombre TipoProceso
    from  tDenuncias td
    ...
    and td.ORGANISMO_ID = @organismoId
    	            and td.FSELLOGCIADC >= @fechaDesdeNGcia
    	            and td.FSELLOGCIADC <= @fechaHastaNGcia
    
END
GO

CREATE PROCEDURE [GetDenunciasPorResponsableFechasNGciayProvincia]
    @responsableId [int],
    @provinciaId [int],
    @fechaDesdeNGcia [datetime],
    @fechaHastaNGcia [datetime]
...
CREATE PROCEDURE [GetDenunciasPorResponsableFechasNGciayServicio]
    @responsableId [int],
    @servicioId [int],
    @fechaDesdeNGcia [datetime],
    @fechaHastaNGcia [datetime]
...
CREATE PROCEDURE [GetDenunciasPorResponsableFechasNGciayEstudio]
    @responsableId [int],
    @estudioId [int],
    @fechaDesdeNGcia [datetime],
    @fechaHastaNGcia [datetime]
...
BEGIN
    ...
    inner join tTipoProceso ttp
    on td.TIPO_PRO_ID = ttp.Id
    	                        where td.RESP_INT_ID is null
    	                        and td.ESTUDIO_ID = @estudioId
    	                        and td.FSELLOGCIADC >= @fechaDesdeNGcia
    	                        and td.FSELLOGCIADC <= @fechaHastaNGcia                                 
...
CREATE PROCEDURE [GetDenunciasPorResponsableFechasNGciaOrganismoyEstadoConc]
    @responsableId [int],
    @organismoId [int],
    @estadoConciliacionId [int],
    @fechaDesdeNGcia [datetime],
    @fechaHastaNGcia [datetime]
AS
BEGIN
    ...
    on td.TIPO_PRO_ID = ttp.Id
    	            where td.RESP_INT_ID = @responsableId
    and td.ORGANISMO_ID = @organismoId
    and td.CONCILIACION_ID = @estadoConciliacionId
    	            and td.FSELLOGCIADC >= @fechaDesdeNGcia
    	            and td.FSELLOGCIADC <= @fechaHastaNGcia
...
CREATE PROCEDURE [GetDenunciasPorResponsableFechasNGciaProvinciayEstadoConc]
    @responsableId [int],
    @provinciaId [int],
    @estadoConciliacionId [int],
    @fechaDesdeNGcia [datetime],
...
CREATE PROCEDURE [GetDenunciasPorResponsableProvinciayEstadoConc]
    @responsableId [int],
    @provinciaId [int],
    @estadoConciliacionId [int]
AS
...
CREATE PROCEDURE [GetDenunciasPorResponsableOrganismoyEstadoConc]
    @responsableId [int],
    @organismoId [int],
    @estadoConciliacionId [int]
AS
...
CREATE PROCEDURE [GetDenunciasPorResponsableApellidoyDniDen]
    @responsableId [int],
...
CREATE PROCEDURE [GetDenunciasPorResponsableyApellidoDenunciante]
    @responsableId [int],
    @apellido [nvarchar](max)
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorResponsableyDniDenunciante]
    @responsableId [int],
    @dni [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorOrganismoyFechasNGcia]
    @organismoId [int],
    @fechaDesdeNGcia [datetime],
    @fechaHastaNGcia [datetime]
AS
BEGIN
    ...
    inner join tTipoProceso ttp
    on td.TIPO_PRO_ID = ttp.Id	           
    where td.ORGANISMO_ID = @organismoId
    	            and td.FSELLOGCIADC >= @fechaDesdeNGcia
    	            and td.FSELLOGCIADC <= @fechaHastaNGcia
