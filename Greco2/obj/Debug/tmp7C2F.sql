CREATE PROCEDURE [GetDenunciasPorOrganismo]
    @organismoId [int]
AS
BEGIN
    ...
    tsub.Nombre as EstadoActual ,ttp.Nombre TipoProceso
    from  tDenuncias td
...
CREATE PROCEDURE [GetDenunciasPorEtapaProcesal]
    @etapaProcesalId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorRegion]
    @regionId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorProvincia]
    @provinciaId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorLocalidad]
    @localidadId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorServicio]
    @servicioId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorIdDenuncia]
    @denunciaId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorEstudio]
    @estudioId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorApellido]
...
CREATE PROCEDURE [GetDenunciasPorDni]
    @dni [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorEstadoConciliacion]
    @estadoId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorNroLinea]
...
CREATE PROCEDURE [GetDenunciasPorMotivoDeReclamo]
    @reclamoId [int]
AS
BEGIN
...
CREATE PROCEDURE [GetDenunciasPorNroExpediente]
...
CREATE PROCEDURE [GetDenunciasPorResponsable]
    @responsableId [int]
AS
BEGIN
